  ...
  <Layout>
    <div class="content">
      <div class="container2">
        <g-image src="~/assets/images/ar.png" alt="icon" style="max-height: calc(100vh - 100px);" />
      </div>
